...
{
    public Mesh<SkinnedVertex> Mesh { get; }
    ...
    public SkinnedVertexDrawData(Mesh<SkinnedVertex> mesh, Matrix4 modelMatrix, Matrix4 transformation, Texture2D? texture, Matrix4[]? bones, Color4 color)
    {
        Mesh = mesh;
