...
public class RectEntity : Entity, IRenderable
{
    ...
    public void Render(RenderArgs args)
    {
        ...
        VertexDrawData vertexDrawData = new VertexDrawData(mesh, matrixStack.GlobalTransformation * cameraData.View * cameraData.Projection, null, Color, PrimitiveType.Triangles);
