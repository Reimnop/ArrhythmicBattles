...
public static class Generate
{
    ...
    {
        private static readonly MultiDistance Infinite = new()
        {
    ...
    {
        protected static readonly SingleDistance Infinite = new() {Dist = SignedDistance.Infinite.Distance};
    }
    ...
    {
        internal static readonly EdgePoint Default = new()
        {
